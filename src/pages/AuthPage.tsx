  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="flex-1 flex items-center justify-center px-6 py-12">
        ...
        >
          <Link to="/" className="flex items-center gap-2 mb-10 hover:opacity-90 transition-opacity">
            <img src="/src/assets/logo-primary.svg" alt="Vouchy Logo" className="h-10" />
          </Link>
      ...
      <div className="hidden lg:flex flex-1 items-center justify-center vouchy-gradient-bg p-12">
        ...
        >
          <div className="w-20 h-20 rounded-2xl bg-primary-foreground/10 backdrop-blur-md flex items-center justify-center mx-auto mb-6 shadow-xl border border-white/10">
            <img src="/src/assets/logo-icon.svg" alt="Vouchy Logo Icon" className="h-12 w-12" />
          </div>
